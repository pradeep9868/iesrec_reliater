...
/**
 * Created by Pradeep on 12/29/2015.
 */

public class StarBang extends TextView {
    ...
    private int centerY;
    private int centerX;
    private int multiply=100;

    public StarBang(Context context) {
        super(context);

        init(null, 0);
    }

    public StarBang(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(attrs, 0);
    }

    public StarBang(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public StarBang(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);

        init(attrs, defStyleAttr);
    }

    public static StarBang attach2Window(Activity activity) {
        ViewGroup rootView = (ViewGroup) activity.findViewById(Window.ID_ANDROID_CONTENT);
        StarBang smallBang = new StarBang(activity);
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        for(int i=0;i<allColors.length;i++)
            colors[i]=Color.parseColor(allColors[i]);
